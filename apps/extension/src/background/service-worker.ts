// MUST be the first import: registers an unhandledrejection listener
// before any module loads the Supabase client, whose constructor kicks
// off an async initialize() that can reject with refresh-token noise.
import './suppress-auth-noise'
